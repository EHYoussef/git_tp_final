...
### Exercice 1 : Forkez moi ça ! (1 points - ... ou sinon 0/20)
...
### Exercice 2 : Présentez-vous ! (3 points)
...
Tout est ok ? 
Faites donc un **commit** et **pushez** moi tout ça sur votre branche principale (master, main, etc. peu importe) (sur **votre** dépôt donc, puisque vous l'avez forké).

> N'importe lequel des collaborateurs peut pusher !

### Exercice 3 : Chacun son boulot ! (8 points)
...
Nous allons désormais fusionner l'ensemble des **features** sur la branche **main (ou master)**.
...
Fusionnez la branche **hotfix/collab-3** sur la branche **main (ou master)**.

#### 2ème fusion :

Fusionnez la branche **feature/collab-2** sur la branche **main (ou master)**.

#### 3ème fusion :

Fusionnez la branche **feature/collab-1** sur la branche **main (ou master)**.



> Attention, si conflits il y a, à bien communiquer entre vous pour savoir quels changements prendre en compte selon les missions de chacuns !


### Fin des exercices :

Tout est ok ?
Alors n'oubliez pas de **push le résultat des fusions sur main (ou master)** le résultat de toutes ces fusions sur votre dépôt distant et ... ce sera tout pour ce TP :)
...
La notation est assez simple : 

 - Exercice 1 : 1 points (vu qu'il s'agit d'appuyer sur un bouton...)
 - Exercice 2 : 3 points
 - Exercice 3 : 8 points
 - Exercice 4 : 8 points
...
> Attention, étant donné que le travail demandé (côte HTML) est très simples, je serai stricte sur le respect des bonnes pratiques Git vues en cours, alors **FORCEZ-VOUS à bieeeen respecter les bonnes pratiques, même pour des exemples tout bêtes comme ici**.
